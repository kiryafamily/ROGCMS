<?php
// includes/config.php - INFINITYFREE VERSION

// ============================================
// DATABASE CREDENTIALS - UPDATE THESE!
// ============================================
define('DB_HOST', 'localhost');  // From your screenshot
define('DB_NAME', 'if0_41380240_p5_purple_db');  // From your screenshot
define('DB_USER', 'root');  // From your screenshot
define('DB_PASS', '');  // <--- PUT YOUR INFINITYFREE PASSWORD HERE!
